...
difference() {
	...
	union() {
		...
		translate(v = [7.5000000000, 25.2500000000, 10.6250000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 50.5000000000, r = 7.6250000000);
			}
		}
		translate(v = [4.3750000000, -5.0000000000, 0.0000000000]) {
			cube(size = [6.2500000000, 50.2500000000, 6]);
		}
		#translate(v = [-7.6250000000, 0.0000000000, 6]) {
			cube(size = [15.2500000000, 15, 5.5000000000]);
		}
		translate(v = [-7.5000000000, 25.2500000000, 10.6250000000]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 50.5000000000, r = 7.6250000000);
		...
		translate(v = [-10.6250000000, -5.0000000000, 0.0000000000]) {
			cube(size = [6.2500000000, 50.2500000000, 6]);
		}
		#translate(v = [-7.6250000000, 0.0000000000, 6]) {
			cube(size = [15.2500000000, 15, 5.5000000000]);
